...
Virtualized infrastructure used to simulate enterprise environments.

### [Active Directory Lab](projects/ad-lab.md)
Windows Server domain environment used to test authentication and group policy.

### [Microsoft 365 Security Hardening](projects/m365-security.md)
Improving tenant security posture and Secure Score.
